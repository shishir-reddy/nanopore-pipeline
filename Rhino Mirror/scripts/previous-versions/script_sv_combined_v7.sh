...
# 1 paragraph about pipeline right now
# software writing for real time
# fixing the pipeline - resistor and improvements - data analysis - polishing electrical signal
...
#/path/to/NanoPlot
export NANOPLOT="$WORKING_FOLDER/nanoplot - $NAME_DATE_FORMATTED"

#/path/to/ReferenceGenomes
export REFERENCE="/shared/biodata/nanopore/Reference/iGenomes/Homo_sapiens/UCSC/hg19/Sequence/WholeGenomeFasta"
